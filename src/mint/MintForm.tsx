  ...
  return (
	<>
      <div className="phoneview">
		...
		<br/>
		<p>Select an asset and destination chain, and input amount to transfer.</p>
		<div>
		<div className="row selectchaindiv">
		  <div className="col-4"><span>Mint</span></div>
		  <div className="col-6">
		...
		<br/>
		<a href="/mintcheck" className="btn btn-primary" type="submit">Transfer</a>
		{/*
